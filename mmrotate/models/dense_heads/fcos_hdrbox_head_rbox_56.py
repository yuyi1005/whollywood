...
class FCOSHDRBoxHead(FCOSHead):
    ...
    def _predict_by_feat_single(self,
        ...
        gt_idx = gt_pos[:, 1] * int(img_shape[0] / 8) + gt_pos[:, 0]
        ...
        results.scores = torch.ones_like(gt_labels)
    ...
    def save_dota_annfiles(self, results, img_meta):
        ...
        if not os.path.exists(self.save_labels_path):
            os.mkdir(self.save_labels_path)
        with open(os.path.join(self.save_labels_path, 
